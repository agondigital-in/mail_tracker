...
export async function POST(req: NextRequest) {
	try {
		...
		const { smtpServerId, name, host, port, secure, username, password, fromEmail, fromName, isDefault } = body;

		// Validate required fields
		if (!smtpServerId || !name || !host || !port || !username || !password || !fromEmail || !fromName) {
